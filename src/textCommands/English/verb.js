const keyData = require('../../database/data/data_module.json');
const printData = require('../../database/data/data_print.json');
...
module.exports = {
     ...
     callback: async (client, message, args) => {
          ...
          const data_verb = printData[realKey];
